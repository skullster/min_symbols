...
"""  TODO: change name - NewCount to CountList noooo ... """
class NumberList(object):
    ...
    def create_number_list(self):
        ...
        while True :
            ...
            self.number_list.append( temp_list )
